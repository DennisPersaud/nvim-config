...
-- Resize Split
map("n", "<Leader>s", ":resize+10<CR>", options)
map("n", "<Leader>w", ":resize-10<CR>", options)
map("n", "<Leader>a", ":vertical resize+10<CR>", options)
map("n", "<Leader>d", ":vertical resize-10<CR>", options)
